...
st.markdown(
    ...
    <div style="background-color: #FF8C00 ; padding: 10px">
        <h1 style="color: brown; font-size: 48px; font-weight: bold">
           <center> <span style="color: black; font-size: 64px">G</span>yani<span style="color: black; font-size: 64px">G</span>uide <span style="color: black; font-size: 64px">
        </h1>
    </div>
    """,
...
with st.sidebar:
    ...
    st.markdown('''
    ## About~
    This app has been developed by 3 students of NIET :\n
    Kush Kataria [2101330120031]\n
    Priya Sirohi [2101330120039] \n
    Pooja Sharma []
